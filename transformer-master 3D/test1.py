...
# path = 'E:\\PyCharmWorkSpace\\mtsdata\\KickvsPunch\\KickvsPunch.mat'  # lenth=16  input=841 channel=62 output=2
...
print('训练集标签值', train_lable)  # 10
print('测试集标签值', test_lable)
